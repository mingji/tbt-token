...
/**
 * Tbt Network token smart contract.
 */
contract TbtToken is AbstractToken {
  /**
  ...
  /**
   * Create new Tbt Network token smart contract, with given number of tokens issued
   ...
   */
  function TbtToken (uint256 _tokenCount) public {
    owner = msg.sender;
